...
ui<-navbarPage(title = "Hotel App",theme=shinythemes::shinytheme("united"),
                 ...
                 inputPanel(h3(tags$b("MEALS")),
                            ...
                            numericInput("PilauMu",label = "Pilau  Managu",value = 0,min = 0),
              ...
              tabPanel("Stock Book",
                       wellPanel(
                       selectizeInput("Item",label ="Food",choices=list("Milk","Soda","Plastic Soda","Dasani","Water 1/2ltr","Water 1ltr","Minute maid"
                                                                        ,"Chapo","Ndazi","1/2cake","Tm")),#Use the names function with the data to be used
              ...
              tabPanel("Analysis",
                       wellPanel(
                         selectizeInput("Pick",label="Choose column",names(datap)),
                       plotOutput("plot")
                       ),
